  ...
  return (
    <div>
      ...
      <div className="flex md:flex-row flex-col mb-20">
        <div className="hover:text-white border px-10 md:px-16 sm:py-16 py-8 flex flex-col gap-5 text-[15px] hover:bg-primary transition-all duration-300 text-gray-600 cursor-pointer ">
          <b>Effieciency :</b>
          <p>
