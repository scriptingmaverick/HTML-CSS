      ...
      <div className="m-5">
        <div className="flex flex-wrap gap-3">
          <div className="flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cusor-pointer hover:scale-105 transition-all">
            <img src={assets.earning_icon} alt="earn-icon" className="w-14" />
            <div>
          ...
          <div className="flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cusor-pointer hover:scale-105 transition-all">
            ...
            <div>
              ...
              <p className="text-gray-400">Appointmets</p>
            </div>
          </div>
          <div className="flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cusor-pointer hover:scale-105 transition-all">
            <img
        ...
        <div className="bg-white">
          ...
          <div className="pt-4 border border-t-0">
            {dashData.latestAppointments.map((item, index) => (
              <div
                className="flex items-centeer px-6 py-3 gap-3 hover:bg-gray-100"
                key={index}
              >
                <img
